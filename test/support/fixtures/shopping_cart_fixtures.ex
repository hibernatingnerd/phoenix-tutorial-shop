defmodule Testshop.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Testshop.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> Testshop.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> Testshop.ShoppingCart.create_cart_item()
