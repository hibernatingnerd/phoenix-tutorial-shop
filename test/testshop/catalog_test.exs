defmodule Testshop.CatalogTest do
  use Testshop.DataCase

  alias Testshop.Catalog

  describe "products" do
    alias Testshop.Catalog.Product

    import Testshop.CatalogFixtures
  ...
  describe "categories" do
    alias Testshop.Catalog.Category
